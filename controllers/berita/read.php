...
<a href="<?= $WEB_CONFIG['base_url'] ?>halaman/berita.php?page=add" class="btn btn-primary mb-3">
    ...
    <table class="table table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $data['content_berita'] ?></td>
                <td><?= $data['tanggal'] ?></td>
                <td><?= $data['gambar'] ?></td>
                <td>
                    <!-- PROSES EDIT MENGIRIMKAN ID DENGAN METHOD GET -->
                    <a href="<?= $WEB_CONFIG['base_url'] ?>halaman/berita.php?page=update&id_berita=<?= $data['id_berita'] ?>" class="btn btn-success m-1">
                    ...
                    <a href="javascript:alertDelete(<?= $data['id_berita'] ?>);" class="btn btn-danger m1">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
    ...
    $('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>halaman/berita.php?page=delete&id_berita='+idn);
