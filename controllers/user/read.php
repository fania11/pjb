        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $WEB_CONFIG['base_url'] ?>halaman/user.php?page=update&id_user=<?= $data['id_user'] ?>" class="btn btn-success m-1">
                    ...
                    <a href="javascript:alertDelete(<?= $data['id_user'] ?>);" class="btn btn-danger m1">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
