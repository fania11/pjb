...
<a href="<?= $WEB_CONFIG['base_url'] ?>halaman/user.php?page=add" class="btn btn-primary mb-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $WEB_CONFIG['base_url'] ?>halaman/user.php?page=update&id_user=<?= $data['id_user'] ?>" class="btn btn-success m-1" style="display: inline-block;">
                    ...
                    <a href="javascript:alertDelete(<?= $data['id_user'] ?>);" class="btn btn-danger m-1" style="display: inline-block;">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
    ...
    $('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>halaman/user.php?page=delete&id_user='+idn);
