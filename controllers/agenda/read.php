...
<a href="<?= $WEB_CONFIG['base_url'] ?>halaman/agenda.php?page=add" class="btn btn-primary mb-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $WEB_CONFIG['base_url'] ?>halaman/agenda.php?page=update&id_agenda=<?= $data['id_agenda'] ?>" class="btn btn-success m-1">
                    ...
                    <a href="javascript:alertDelete(<?= $data['id_agenda'] ?>);" class="btn btn-danger m1">
                    <svg style="width:20px;height:20px" viewBox="0 0 24 24" class="mb-1">
...
function alertDelete(idn) {
    ...
    $('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>halaman/agenda.php?page=delete&id_agenda='+idn);
