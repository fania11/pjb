...
<a href="<?= $WEB_CONFIG['base_url'] ?>halaman/galeri.php?page=add" class="btn btn-primary mb-3">
...
function alertDelete(idn) {
    ...
    $('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>halaman/galeri.php?page=delete&id_galeri='+idn);
