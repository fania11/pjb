...
<?php session_start();
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="berita.php">Data Berita</a>
                        <a class="collapse-item" href="galeri.php">Data Galery</a>
                        <a class="collapse-item" href="agenda.php">Data Agenda</a>
                    </div>
                </div>
            </li>
        ...
        <div class="row">
            ...
            switch ($content) {
                case 'add':
                    require '../controllers/agenda/create.php';
                    break;
                case 'delete':
                    require '../controllers/agenda/delete.php';
                    break;
                case 'update':
                    require '../controllers/agenda/update.php';
                    break;
                //YANG PERTAMA KALI DI JALANKAN SELAIN DARI CASE DIATAS
                default: 
                    require '../controllers/agenda/read.php';
                    break;
            } ?>
            </div>
        </div>
